...
app = Flask(__name__)
app.secret_key = "4432157"  # Set your secret key for session encryption, would be stored securely in a production enviroment

# Initialise OpenSearch client
client = OpenSearch(
    hosts=["https://localhost:9200"],
    http_auth=("admin", "admin"),  # These credentials would be encoded and stored securely for a producation enviroment 
    verify_certs=False,
